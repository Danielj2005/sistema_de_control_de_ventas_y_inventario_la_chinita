        ...
        <div class="modal-body">
          <div class="row m-0">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-3">
              ...
              <input type="text" step="any" minlength="3" maxlength="8" class="modificar_proveedor form-control" id="priceDolar" name="priceDolar" placeholder="ingresa el precio del dolar">
            </div>
