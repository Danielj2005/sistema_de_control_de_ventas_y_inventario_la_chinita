...
if (isset($_POST['servicio'])) {
    ...
    for($i = 0; $i < COUNT($id_menu); $i++){
        $datos_servicio = mysqli_fetch_array(modeloPrincipal::Consultar("SELECT nombre_platillo, id_menu, precio_dolar,descripcion
        ...
        <tr id="servicio_<?= $id_menu[$i] ?>">
            ...
            <td class="col text-center" id="descripcion_<?= $id_menu[$i] ?>"> <?= $datos_servicio['descripcion'] ?> </td>
