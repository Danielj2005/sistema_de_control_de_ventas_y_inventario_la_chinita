...
while ( $mostrar = mysqli_fetch_array($consulta)) { 
    ...
    echo '
        <tr class="producto_" id="producto_'.$mostrar["id_producto"].'" >
            ...
            <td class="col text-center" scope="col">
                <input type="text" class="input form-control" name="precio_venta_dolar[]" placeholder="ingresa el Precio de venta en $" id="precio_venta_dolar_'.$mostrar["id_producto"].'" required>
            </td>
