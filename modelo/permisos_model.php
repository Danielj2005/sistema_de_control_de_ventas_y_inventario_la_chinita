...
class permisos_model extends rol_model {

    public function obtenerPermisoProveedores () {
                
        return $PERMISOS_MODULO_PROVEEDORES = [
    ...
    public static function obtenerPermisoProductos () {
        ...
        return $PERMISOS_MODULO_PRODUCTOS;
    } 


    public function obtenerPermisoVentas () {
        
        // Módulo venta
        return $PERMISOS_MODULO_VENTAS = [
    ...
    public function obtenerPermisoServicios () {
                
        // Módulo servicio
        return $PERMISOS_MODULO_SERVICIOS = [
    ...
    public function obtenerPermisoCliente () {
        
        // Módulo de Usuarios
        return $PERMISOS_MODULO_CLIENTES = [
    ...
    public function obtenerPermisoUsuarios () {
                
        
        return $PERMISOS_MODULO_USUARIOS = [
    ...
    public function obtenerPermisoRoles () {
                
        
        return $PERMISOS_MODULO_ROLES = [
    ...
    public function obtenerPermisoAjustes () {
                
        return $PERMISOS_MODULO_AJUSTES = [
    ...
    public function obtenerPermisoBitacora () {
                
        return $PERMISOS_MODULO_BITACORA = [
