      ...
      <ul class="d-flex align-items-center">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            <li class="dropdown-header">
              <p id="tasa_dolar">LA TASA DEL DIA ES: </p>
              <a href="#" onclick="consulta_tasa_dolar();"><span class="badge rounded-pill bg-primary p-2 ms-2">ACTUALIZAR PRECIO DEL DOLAR</span></a>
            </li>
            <li>
