...
<?php }else{
  ...
  modeloPrincipal::bitacora("Intento de acceso no autorizado a la pantalla registro de roles.","Se ha registrado un intento de acceso incorrecto a la pantalla registro de roles por parte de un usuario sin los permisos necesarios. Por motivos de seguridad, el usuario fue redirigido a la pantalla de inicio.");
