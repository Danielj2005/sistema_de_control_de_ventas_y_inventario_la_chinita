...
<?php }else{
  ...
  modeloPrincipal::bitacora("Intentó acceder sin permisos a la pantalla generar venta.","El usuario intentó acceder de manera incorracta a la pantalla y sin tener los permisos correspondientes, este fué redirigido a la pantalla de inicio por seguridad.");
