...
$pdf->Cell(65, 5, $pdf->convert_codification('Marca'),'LTRB',0,'C',0);
$pdf->Cell(65, 5, $pdf->convert_codification('Categoría'),'LTRB',0,'C',0);
...
//     $pdf->Cell(65, 5, $pdf->convert_codification($mostrar["presentacion"].' '.$mostrar["representacion"]),'B',0,'C',0);
//     $pdf->Cell(65, 5, $pdf->convert_codification($mostrar["marca"]),'B',0,'C',0);
//     $pdf->Cell(65, 5, $pdf->convert_codification($mostrar["categoria"]),'B',0,'C',0);
...
//     $pdf->Cell(30, 5, $pdf->convert_codification(number_format($precio_bolivares, 2, ',', '.') .' bs'),'B',0,'C',0);
