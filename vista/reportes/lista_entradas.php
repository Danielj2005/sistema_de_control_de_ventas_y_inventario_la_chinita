...
class PDF extends FPDF{
    function Header(){
        ...
        $this->setY(40);
        $this->setX(10);
        $this->Cell(0,5,utf8_decode("Lista de Entradas"),0,0,"C");
...
$consulta = modeloPrincipal::consultar("SELECT P.nombre_producto, P.precio_compra_dolar, PROV.nombre, E.stock_comprado, E.fecha_entrada 
    FROM entrada AS E INNER JOIN producto AS P ON P.id_producto = E.id_producto 
...
if (mysqli_num_rows($consulta) < 1 ){
    ...
    $pdf->Cell(40, 5, utf8_decode('PRECIO DE COMPRA'),'B',0,'C',0);
...
$pdf->Cell(50, 5, utf8_decode('PROVEEDOR'),'B',0,'C',0);
$pdf->Cell(35, 5, utf8_decode('PRECIO DE COMPRA'),'B',0,'C',0);
$pdf->Cell(35, 5, utf8_decode('CANTIDAD COMPRADA'),'B',0,'C',0);
$pdf->Cell( 35, 5, utf8_decode('FECHA / HORA'),'B',1,'C',0);
...
while ( $mostrar = mysqli_fetch_array($consulta)) { 
    ...
    $pdf->Cell(35, 5, utf8_decode($mostrar["precio_compra_dolar"].'$'),'B',0,'C',0);
    $pdf->Cell(35, 5, utf8_decode($mostrar["stock_comprado"]),'B',0,'C',0);
    $pdf->Cell(35, 5, utf8_decode($mostrar["fecha_entrada"]),'B',1,'C',0);
