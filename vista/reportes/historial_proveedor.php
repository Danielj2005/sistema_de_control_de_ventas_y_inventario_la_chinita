...
$pdf->Cell(0,10,utf8_decode("BAR RESTAURANT Y LUNCHERIA 'LA CHINITA'"),0,1,'C');

$pdf->SetFont('Arial','',16);
$pdf->Cell(0,7,utf8_decode("PISTA DE BAILE Y MESA DE POOL"),0,1, 'C');

$pdf->Cell(0,7,utf8_decode("RIF: V-04608675-5"),0,1,'C');

$pdf->Cell(0,7,utf8_decode("Calle 2 entre Av 5 y 6 - Turén Edo. Portuguesa"),0,1,'C');

$pdf->Ln(5);
$pdf->Cell(0,7,utf8_decode("Historial de Proveedor"),0,1,'C');
...
if (mysqli_num_rows($consulta) < 1 ){
    ...
    $pdf->Cell(20,8, utf8_decode("Nº"),'B',0,'C',0);
    $pdf->Cell(35,8, utf8_decode("CÓDIGO"),'B',0,'C',0);
    $pdf->Cell(30,8, utf8_decode(" "."PRODUCTO"),'B',0,'C',0);
    $pdf->Cell(40,8, utf8_decode("PRESENTACIÓN"),'B',0,'C',0);
    $pdf->Cell(40,8 , utf8_decode("CANTIDAD COMPRADA"),'B',0,'C',0);
    $pdf->Cell(50,8, utf8_decode("CATEGORÍA"),'B',0,'C',0);
    $pdf->Cell(50,8, utf8_decode("PRECIO DE COMPRA EN $"),'B',0,'C',0);
    $pdf->Cell(50,8, utf8_decode("PRECIO DE COMPRA EN BS"),'B',0,'C',0);
...
while ( $row = mysqli_fetch_array($consulta)) { 
	...
	$pdf->Cell(35,8, utf8_decode($row['codigo']),'B',0,'C',0);
	$pdf->Cell( 30,8, utf8_decode($row['nombre_producto']),'B',0,'C',0);
	$pdf->Cell(40,8, utf8_decode($row['nombre_presentacion']),'B',0,'C',0);
