<?php
    ...
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1",strtoupper("Bar Restaurante La Chinita")),0,'C',false);
    $pdf->SetFont('Arial','',9);
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","RIF: 0000000000"),0,'C',false);
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","Direccion: Calle 2 Eentre Av 5 y 6"),0,'C',false);
    ...
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","Cajero: Anderso Sanchez"),0,'C',false);
    $pdf->SetFont('Arial','B',10);
    ...
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","Cliente: Jose Solanillo"),0,'C',false);
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","Documento: V-00000000"),0,'C',false);
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","Teléfono: 00000000"),0,'C',false);
    $pdf->MultiCell(0,5,iconv("UTF-8", "ISO-8859-1","Dirección: Villa Bruzual Turén,Portuguesa, Venezuela"),0,'C',false);
