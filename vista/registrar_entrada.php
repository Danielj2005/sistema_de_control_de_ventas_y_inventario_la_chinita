          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <form method="post" action="../controlador/realizar_entrada.php" class="row g-3">
                ...
                <div class="col-md-4">
                  <label for="validationDefault01" class="form-label">CEDULA/RIF DEL PROVEEDOR</label>
                    <div class="col-md-4 input-group">
                        ...
                        <select class="input-group-text" id="validationDefault04" required>
                          ...
                          <input type="text" class="form-control"  placeholder="CEDULA/RIF DEL PROVEEDOR" onblur="buscar_proveedor()"; name="cedula" id="cedula" required>
                      </div>
                </div>

                <div class="col-md-4">
                  <label for="validationDefault02" class="form-label">NOMBRE DEL PROVEEDOR</label>
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="direccion" placeholder="DIRECCIÓN" id="direccion" required>
                </div>
                
                <div class="col-md-6">
                  <label for="validationDefault05" class="form-label">TELÉFONO</label>
                  <input type="text" class="form-control" name="telefono" placeholder="TELÉFONO" id="telefono" required>
                </div>
                ...
                <div class="col-md-6">
                  <label for="validationDefault05" class="form-label">CANTIDAD QUE DESEA INGRESAR</label>
                  <input type="text" class="form-control" name="cantidad" placeholder="CANTIDAD QUE DESEA COMPRAR" id="cantidad" required>
                </div>

                <div class="col-md-6">
                  <label for="validationDefault05" class="form-label">PRECIO POR PRODUCTO EN BASE A LA TASA REGISTRADA</label>

                  <div class="input-group">
                      <input type="text" class="form-control" name="precioDolares" placeholder="PRECIO INDIVIDUAL DEL PRODUCTO" onblur="transformar()" id="precioDolares" required>
                      <span class="input-group-text">$</span>
                  </div>
                </div>
                <div class="col-md-6">
                  <label for="validationDefault05" class="form-label">PRECIO POR PRODUCTO EN BASE A LA MONEDA NACIONAL</label>
                  <div class="input-group">
                      <input type="text" disabled class="form-control" name="precioBolivares" placeholder="PRECIO INDIVIDUAL DEL PRODUCTO" id="precioBolivares" required>
