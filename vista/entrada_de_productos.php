...
$rol = modeloPrincipal::permisos_modulos('r_entrada + l_entrada');
              ...
              <div class="card top-selling ">
                <div class="row btn-group text-center">
                  <div class="col-12 col-sm-12 col-md-6 mb-3 row m-0">
                    <a type="button" class="col-12 btn btn-success" href="./<?= modeloPrincipal::verificar_rol('r_entrada') == 1 ? 'registrar_entrada.php' : 'entrada_de_productos.php' ?>">Registrar Nueva Entrada</a>
                  </div>
                  <div class="col-12 col-sm-12 col-md-6 mb-3 row m-0">
...
<?php }else{
  ...
  modeloPrincipal::bitacora("Intento de acceso no autorizado a la pantalla lista de entradas.","Se ha registrado un intento de acceso incorrecto a la pantalla lista de entradas por parte de un usuario sin los permisos necesarios. Por motivos de seguridad, el usuario fue redirigido a la pantalla de inicio.");
